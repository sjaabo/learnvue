  ...
  <form @submit.prevent="submitForm">
    ...
    <div class="form-control">
      ...
      <select id="referrer" name="referrer" v-model="userReferrer">
        ...
        <option value="wom" selected>Word of mouth</option>
    ...
    <div class="form-control">
      <input
        ...
        v-model="userConfirm"
      />
      <label for="confirm-terms">Terms & Condition</label>
    </div>
    <div>
...
export default {
  ...
  data() {
    return {
      userName: '', //text
      userAge: null, //number
      userReferrer: 'wom', //dropdown box
      userHow: null, //radio
      userInterest: [], //multiple checkbox
      userConfirm: false, //one checkbox
  ...
  methods: {
    submitForm() {
      ...
      //console.log(this.userAge + 5); //41+5 = 46
      //console.log(this.$refs.ageInput.value + 5); //'41' + '5' = '416' no auto typpe conversion
      this.userAge = null;

      console.log('Refferer: ' + this.userReferrer);
